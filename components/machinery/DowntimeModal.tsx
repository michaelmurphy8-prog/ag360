        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <select value={form.assetId} onChange={e => update("assetId", e.target.value)}
              className="w-full mt-1 bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 py-2.5 text-sm text-ag-primary focus:border-[#EF4444]/40 focus:outline-none">
          ...
          <div>
            ...
            <textarea rows={3} value={form.notes} onChange={e => update("notes", e.target.value)} placeholder="What happened..."
              className="w-full mt-1 bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 py-2.5 text-sm text-ag-primary focus:border-[#EF4444]/40 focus:outline-none resize-none" />
          </div>
        </div>
