            ...
            {(form.type === 'trucker' || form.type === 'applicator') && (
              <div className="rounded-2xl p-4 space-y-3"
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label style={labelStyle}>ISS. Province / State</label>
                ...
                {form.holds_licence && (
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <select style={inputStyle} value={form.driver_licence_province} onChange={e => set('driver_licence_province', e.target.value)}>
                        <option value="">Select...</option>
                        <optgroup label="Canadian Provinces & Territories">
                          <option value="AB">AB — Alberta</option>
                          <option value="BC">BC — British Columbia</option>
